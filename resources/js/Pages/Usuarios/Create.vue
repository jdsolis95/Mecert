        ...
        <div class="p-6 max-w-2xl mx-auto">
            ...
            <form @submit.prevent="guardar" class="space-y-4">
                ...
                <div>
                    ...
                    <p v-if="form.errors.cedula" class="text-red-500 text-xs mt-1">
                        {{ form.errors.cedula }}
                    </p>
                </div>
                ...
                <div>
                    ...
                    <select v-model="form.rol" class="w-full border rounded p-2">
                        <option value="">-- Seleccione un rol --</option>
                        <option v-for="rol in roles" :key="rol" :value="rol">
                            {{ rol }}
                        </option>
                    </select>
                    <p v-if="form.errors.rol" class="text-red-500 text-xs mt-1">
                        {{ form.errors.rol }}
                    </p>
                </div>
